...
namespace HostelDll.DlDb
{
    public class RtDb
    {
        ...
        public static bool DeleteRtByHostelName(string hostelName, string connectionString)
        {
        ...
        public static bool InsertRt(RT resident ,int residentId,string connectionString)
        {
        ...
        public static bool DeleteRt(string rtName,string  connectionString)
        {
            SqlConnection connection = new SqlConnection(connectionString);
        ...
        public static string GetHostelOfSelectedRt(string username, string connectionString)
        {
            string hostel = null;
            SqlConnection connection = new SqlConnection(connectionString);
            connection.Open();
        ...
        public static bool IsDuplicateRt(string username, string connectionString)
        {
        ...
        public static bool UpdateRtPassword(string password, string name, string connectionString)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            connection.Open();
        ...
        public static RT GetRtByName(string name, string connectionString)
        {
            SqlConnection connection = new SqlConnection(connectionString);
            connection.Open();
        ...
        public static List<RT> GeAllRts (string connectionString)
        {
        ...
        public static List<string> GeAllRtNames(string connectionString)
        {
